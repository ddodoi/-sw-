...
pygame.mixer.music.load("C:/Users/cksdn/Downloads/MyGame_211105/background.mp3") #배경음악을 셋팅
pygame.mixer.music.play(-1)


background = pygame.image.load("C:/Users/cksdn/Downloads/MyGame_211105/background.png")#배경 맵
...
hero.setImage("C:/Users/cksdn/Downloads/MyGame_211105/buzz.png")
...
bullet.setImage("C:/Users/cksdn/Downloads/MyGame_211105/bullet.png")
bullet.setScale(20, 20)
bullet.setPosition(hero.centerX, hero.centerY)
bullet.setSound("C:/Users/cksdn/Downloads/MyGame_211105/laser.wav")
bullet.estimateCenter()


enermy = Actor.Actor(pygame) #actor클래스를 사용하여 객체(적) 하나를 더 생성
enermy.setImage("C:/Users/cksdn/Downloads/MyGame_211105/bacteria1.png")
