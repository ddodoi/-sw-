...
image_human = pygame.image.load(
    "C:/Users/cksdn/project/cwLee/img/1st_left_front_img.png").convert_alpha()
...
image_wall = pygame.image.load(
    "C:/Users/cksdn/project/cwLee/img/Room1_wall.png").convert_alpha()
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_w:
                ...
                image_human = pygame.image.load(
                    "C:/Users/cksdn/project/cwLee/img/2nd_left_front_img.png")
