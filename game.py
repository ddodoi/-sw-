...
h_img = "C:/Users/cksdn/project/img/1st_left_front_img.png"
...
human_walk_sound = pygame.mixer.Sound(
    "C:/Users/cksdn/project/sound/walksound.mp3")
...
door_sound = pygame.mixer.Sound(
    "C:/Users/cksdn/project/sound/doorsound.mp3")

w_img = "C:/Users/cksdn/project/img/Room1_final.png"
...
background_sound = pygame.mixer.music.load(
    "C:/Users/cksdn/project/sound/background.mp3")
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_UP:
                ...
                if y_pos_human == 233 and x_pos_human >= 210 and x_pos_human <= 275:
                    ...
                    pygame.display.update()
                    pygame.time.delay(1200)
                    h_img = "C:/Users/cksdn/project/img/2nd_left_front_img.png"
                    image_human = pygame.image.load(h_img).convert_alpha()
                    ...
                    w_img = "C:/Users/cksdn/project/img/Room2_final.png"
                    image_wall = pygame.image.load(w_img).convert_alpha()
